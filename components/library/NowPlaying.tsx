...
const AnimatedBars = () => {
  ...
  return (
    <div className="w-auto flex items-end overflow-hidden sm:mr-2">
      <span id="bar1" className="w-1 mr-[3px] h-2 bg-primary opacity-75" />
      <span id="bar2" className="w-1 mr-[3px] h-1 bg-primary" />
    ...
    <div className="flex mt-2 flex-row-reverse justify-center items-center sm:flex-row  space-x-0 sm:space-x-2 w-full">
      ...
      >
        {data?.songUrl ? (
          ...
          <svg className="h-7 w-7 sm:mr-2" viewBox="0 0 168 168">
            <path
              fill="#1ED760"
